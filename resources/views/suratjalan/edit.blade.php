        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('po.create', ['from' => 'invoice', 'invoice_number' => request('invoice_number'), 'reset_fields' => '1']) }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
