...
@php
    $styles = [
        ...
        'info' => [
            ...
            'icon' => '<svg class="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/></svg>',
...
<div class="{{ $currentStyle['container'] }} border-l-4 p-4 mb-6 rounded-r-lg shadow-sm" 
     @if($dismissible) x-data="{ show: true }" x-show="show" x-transition @endif>
    <div class="flex items-center @if($dismissible) justify-between @endif">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                {!! $currentStyle['icon'] !!}
            </div>
            <div class="ml-3 {{ $currentStyle['text'] }}">
                @if($message)
        ...
        @if($dismissible)
        <button @click="show = false" class="ml-4 inline-flex text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
